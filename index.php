        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              ...
              <p>Register on our website right now and we will make it easier for you to find your dream Job!.</p>
            </div>
            <form method="post" action="search.php" class="search-jobs-form">
              ...
              <div class="row">
                <div class="col-md-12 popular-keywords">
                  <h3>Trending Keywords: finance, marketing, accounting, IT, Web developer</h3>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-8">
            ...
            <p class="mb-0 text-white lead">Create your profile now to get noticed and we will help you find the job you have always wanted. With JobBoard, open the door to countless job opportunities with an extensive list of registered employers.</p>
          </div>
          ...
          <div class="col-12 text-center mt-4 mb-5">
            <div class="row justify-content-center">
              <div class="col-md-7">
                ...
                <p class="lead">National Commercial Bank, Sagility Jamaica Limited, Mayberry Investments Limited, Vangaurd, Morgan Stabley, Barita, KPMG Jamaica, Microsoft, Google and many more.</p>
              </div>
            </div>
        ...
        <div class="owl-carousel single-carousel">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;Thank you JobBoard for helping me find my dream Job at Microsoft. The steps on your website is so easy and you delivered on your promise.&rdquo;</p>
                  <p><cite> &mdash; Charlie Whitmore, @Microsoft</cite></p>
                </blockquote>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;I turned to JobBoard as a way to gain more control of my career. I love being able to choose everything from who I work with to how I spend my day.&rdquo;</p>
                  <p><cite> &mdash; Chris Phillips, @Google</cite></p>
                </blockquote>
              </div>
              <div class="col-lg-6 align-self-end text-center text-lg-right">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
            ...
            <p class="mb-5 lead text-white">Connect with us conveniently using our app.</p>
            <p class="mb-0">
