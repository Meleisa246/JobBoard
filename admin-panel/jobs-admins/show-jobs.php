              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php if($job->status == 1) : ?>
                      <td><a href="<?php echo ADMINURL; ?>/jobs-admins/status-jobs.php?id=<?php echo $job->id; ?>&status=<?php echo $job->status; ?>" class="btn btn-danger  text-center ">Unverified</a></td>
                    <?php else : ?>
